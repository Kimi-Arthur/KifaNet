...
namespace Pimix.Apps.JobUtil {
    abstract class JobUtilCommand {
        ...
        [Option("pimix-server-credential", HelpText = "Credential to access api server, with form: username:password")]
        public string PimixServerCredential { get; set; } = ConfigurationManager.AppSettings["PimixServerCredential"];
        ...
        public virtual void Initialize() {
            ...
            PimixService.PimixServerCredential = Convert.ToBase64String(Encoding.UTF8.GetBytes(PimixServerCredential));
        }
