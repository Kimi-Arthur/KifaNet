...
namespace Kifa.Bilibili.Tests {
    public class BilibiliMediaTests {
        ...
        public void MediaSeasonRpcTest(string seasonId, string title, long episode1Id, string episode1Title,
            string episode1LongTitle, string otherTitle = null, long otherEpisode1Id = 0,
            string otherEpisode1Title = null, string otherEpisode1LongTitle = null) {
